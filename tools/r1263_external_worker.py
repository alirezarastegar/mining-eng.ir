...
def call(action,**kwargs):
    ...
    req=urllib.request.Request(BROKER,data=json.dumps(payload,separators=(",",":")).encode(),headers={"Authorization":"Bearer "+OIDC,"Content-Type":"application/json"},method="POST")
    try:
